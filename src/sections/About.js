      ...
      <div>
        ...
        <ul className="about-content contact-list">
          <li>
            ...
            <strong>Phone:</strong> +91 8828587896
          </li>
          <li>
      ...
      <div>
        ...
        <ul className="about-content">
          <li>
            ...
            <span className="about-highlight">Cyber Security</span>, University of Mumbai (2020-2024)
          </li>
          <li>
            Final Semester CGPA: <span className="about-highlight">9.71</span>
          </li>
          <li>
            Average CGPA: <span className="about-highlight">8.7</span>
          </li>
          <li>
